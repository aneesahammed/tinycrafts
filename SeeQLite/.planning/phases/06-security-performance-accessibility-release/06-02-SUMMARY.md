...
| Large-file performance | Exact 25/50 MiB oversized catalogs plus 64/128/256 MiB SQLite generation; import, query, cancel acknowledgement, reopen, reimport, bounded catalog/result DOM | PASS (21/21; Chromium, Firefox, WebKit; qualified local 64 GiB arm64 profile; final samples in `docs/release/performance.md`) |
...
- Constrained-host memory pressure remains a release gate; the exact 25/50 MiB safe-mode matrix is now automated.
