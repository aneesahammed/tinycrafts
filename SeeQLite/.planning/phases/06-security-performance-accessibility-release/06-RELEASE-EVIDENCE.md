...
| A11Y-01 | New relationship, copy, metadata, toggle, paging, and forced-colors controls preserve serious/critical axe cleanliness in light/dark themes and all three browser engines. | `npm run test:e2e` (96/96; axe plus forced-colors/zoom/reduced-motion paths in Chromium/Firefox/WebKit) | PASS for automated gates; manual Safari/VoiceOver/NVDA remains |
...
SeeQLite: npm run test:e2e                  PASS (96 tests; Chromium, Firefox, WebKit)
