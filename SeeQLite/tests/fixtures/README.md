...
- `exotic.sqlite` is generated from `exotic.sql` and covers FTS4 and RTree virtual modules, their shadow objects, and a `points_archive` near-collision that must remain a visible user table.
