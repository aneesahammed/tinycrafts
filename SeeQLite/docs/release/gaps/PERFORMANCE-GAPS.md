...
| 25/50 MiB catalog and low-memory matrices remain unmeasured | Existing limited/wide fixtures prove 5,001-object and 52,000-column safe modes; the size/memory matrix is not part of this run | Medium | Catalog owner | Add deterministic 25/50 MiB catalog fixtures and rerun all three engines on constrained memory |
